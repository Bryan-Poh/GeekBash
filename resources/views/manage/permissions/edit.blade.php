...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10">
      ...
      <div class="column">
        <a href="{{route('manage.permissions.edit', $permission->id)}}" class="button is-primary is-pulled-right"><i class="fa fa-edit m-r-10"></i> Edit Permission</a>
      </div>
    </div>
    <hr class="m-t-0">

    <form action="{{route('manage.permissions.update', $permission->id)}}" method="POST">
      {{csrf_field()}}
      {{method_field('PUT')}}
